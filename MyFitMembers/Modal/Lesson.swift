...
//  MyFitMembers
//
//  Created by Boris Esanu on 10/22/16.
...
class Lesson: NSObject, JSONDecodable {
    ...
    class func changeDictionaryToUserArray(_ array1 : [JSON])->[Lesson]{
        var tempArr : [Lesson] = []
        for dict in array1 {
...
class LessonDone: NSObject , JSONDecodable {
    ...
    class func changeDictionaryToArray(_ array1 : [JSON])->[LessonDone]{
