...
//  MyFitMembers
//
//  Created by Boris Esanu on 02/11/16.
...
class QuizQuestions: NSObject , JSONDecodable{
    ...
    class func changeDictionaryToUserArray(_ array1 : [JSON])->[QuizQuestions]{
...
class QuizAnswers: NSObject , JSONDecodable{
    ...
    class func changeDictionaryToUserArray(_ array1 : [JSON])->[QuizAnswers]{
