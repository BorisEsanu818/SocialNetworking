...
class ClientFitnessAssessmentsViewController: UIViewController , LineChartDelegate , IndicatorInfoProvider , AddNewFitnessToExistingChart {
    ...
    @IBAction func btnActionAddFitnessAssessment(_ sender: UIButton) {
        print(self.item)
        ...
        if item == nil{
            ...
            assessmentVc.item = ["Push-ups" as AnyObject,"Sit-ups" as AnyObject,"Pull-ups" as AnyObject,"Burpees" as AnyObject]
            pushVC(assessmentVc)
        }else{
            ...
            assessmentVc.item = itemArray as [AnyObject]?
            pushVC(assessmentVc)
        }
