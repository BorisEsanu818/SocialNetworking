...
class DashBoardViewController: UIViewController , BannerRemoved {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(DashBoardViewController.handlePush), name: NSNotification.Name(rawValue: "Push"), object: nil)
    ...
    func collaborateCellImages(){
        item = ["ic_clients" as AnyObject,"ic_lessons" as AnyObject,"ic_broadcastLarge" as AnyObject , "ic_nutrition-1" as AnyObject]
    ...
    @IBAction func btnActionSidePanel(_ sender: UIButton) {
        toggleSideMenuView()
    }
